...
os.environ["LANGSMITH_PROJECT"] = "LangGraph v1"
...
structured_model = chat_model.with_structured_output(EvaluationSchema)
...
graph.add_edge(["evaluate_language", "evaluate_analysis", "evaluate_thought"], "final_evaluation")
